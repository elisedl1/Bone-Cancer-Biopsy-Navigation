...
%%QUESTION3 - Reconstruct Sphere
% [C,R]=sphereFit(X) Reconstuct Sphere
%
% INPUTS:
%         X     - Points as a matrix
%         
% OUTPUTS:
%         C     - Center of reconstucted sphere
%         R     - Radius of reconstructed sphere
...
%Alan Jennings (2022). Sphere Fit (least squared) 
